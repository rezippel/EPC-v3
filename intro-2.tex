...
\end{verbatim}
\mdline{\frac{\sqrt{2Em}}{\hbar}}{D2}
\begin{verbatim}
(C3) BETA:SQRT(2*M*(E-V))/HBAR;
\end{verbatim}
\mdline{\frac{\sqrt{2 m \,(E-V)}}{\hbar}}{d3}
...
\end{verbatim}
\mdline{\frac{i D \sqrt{2 m \, (E-V)}}{\hbar} -
\frac{i C \sqrt{2 m \,(E-V)}}{\hbar} -
\frac{i B \sqrt{2Em}}{\hbar}
+ \frac{i \sqrt{2Em}}{\hbar}}{D12}
\begin{verbatim}
...
\end{verbatim}
\mdline{\frac{e^{-\frac{2 i L \sqrt{2Em-2mV}}{\hbar}}
\left( 
\begin{aligned}
    \displaystyle
...
\end{verbatim}
\mdline{V^2 \left( 2 \cos \frac{2 L \sqrt{2Em -2mV}}{\hbar} -2 \right)
+ 16 EV -16E^2}{D22}
...
\mdline{
  \frac{
    \begin{aligned}
       V^2 \left( 2 \left( \cos^2 \frac{L \sqrt{2Em -2mV}}{\hbar}
         - \sin^2 \frac{L \sqrt{2Em -2mV}}{\hbar}\right) -2 \right)\qquad
         \hfill\\
       \hfill+ 16 EV -16E^2
    \end{aligned}}
    {16EV -16E^2}}{D23}
...
\end{verbatim} \mdline{\frac{L \sqrt{2Em - 2mV}}{\hbar}}{D24}
\begin{verbatim}
(C25) SUBSTITUTE(1-SIN(D24)^2,COS(D24)^2,ANS);
\end{verbatim}
\mdline{\frac{V^2
  \left(
    2 \left(1 - 2\sin^2 \frac{2L \sqrt{2Em-2mV}}{\hbar} \right)
    - 2
...
\end{verbatim}
\mdline{\frac{\sin^2 \left(\frac{L \sqrt{2M (E - V)}}{\hbar}\right) V^2}{4E(E-V)} +1}{D26}
