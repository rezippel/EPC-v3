...
which is discussed in \sectref{CountingPrimeFactors:Sec}.  This technique, which
...
\label{CountingPrimeFactors:Sec}
...
tandem with the techniques of \sectref{CountingPrimeFactors:Sec}.  As we shall
...
\sectref{CountingPrimeFactors:Sec} are a deeper and more successful way to combine
